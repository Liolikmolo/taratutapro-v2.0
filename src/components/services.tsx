                            ...
                            <div className = "relative w-full md:max-w-sm">
                                ...
                                >
                                    {servicesData?.data[activeIndex]?.image && (
                                        <Image
                                            src = {servicesData?.data[activeIndex]?.image} alt = "Service image"
                                            width = {400} height = {250} className = "w-full h-full object-cover"
                                        />
                                    )}
                                </div>
                            </div>
                            <div className = "w-full flex flex-col gap-16">
                                <div>
                                    {servicesData?.data.map((item, index) => (
                                        <div
                                            key = {index} onMouseEnter = {(e) => handleMouseEnter(index, e)}
                                    ...
                                    >
                                        ...
                                        >
                                            <g filter = "url(#filter0_d_1_873)">
                                                <rect
                                                    x = "3" y = "2" width = "52" height = "52" rx = "26" fill = "white"
                                                />
                                                <path
